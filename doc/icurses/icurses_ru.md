...
См. также пример `doc/icurses/examples/04_02_low_level_terminal.b`, демонстрирующий схему приложения, которое использует только низкоуровневый модуль `Icurses` без `IcUi`, дерева элементов и renderer-а.
